...
export const UploadFile = () => {
    ...
    reader.onload = (e) => {
      if (e.target && typeof e.target.result === "string") {
        try {
          ...
          startProcessing();
          setFileContent(json);
          console.log("Parsed JSON:", json); // JSON verisi burada
        } catch (error) {
  ...
  return (
    <div className="border-[#F66B05] border rounded-3xl w-2/3">
      <div className="p-8 flex items-stretch justify-between border-b border-[#CBD0DC]">
        <div className="flex items-stretch gap-x-4">
          ...
          <div className="flex flex-col h-full justify-between">
            <p className="text-[#121211] text-opacity-70 font-extrabold">
              {!fileContent ? "Upload files" : "Proof is valid."}
            </p>
      ...
      <div className="p-8">
        <div className="container px-4 max-w-5xl mx-auto">
          ...
          {/* {isProcessing && (
            <div className="bg-[#FFECDE] rounded-xl p-6 mt-6 flex items-stretch justify-between">
